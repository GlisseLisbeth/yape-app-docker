...
const RegisterNum = (update) => {
  const parent = $('<div class="container screen register"></div>');
  ...
  const terms = $('<div></div>');
  const label = $('<label for="agree"></label>');
  const condiction = $('<span>Acepto los<a href="#" class="light-turquoise">Términos y condiciones</a></span>')
